...
/**
 * Admin login — Design Centura CRM uses labelled textboxes; "Sign In" stays disabled until fields validate.
 * https://designcentura.com/crm-pay/admin/login
 */
class LoginPage {
  ...
  /**
   * Resilient selectors — labels/button text site par change ho sakte hain.
   * @param {string} email
